...
print(conjunto2.issubset(conjunto1))  # issubset significa "es un subconjunto?"
print(conjunto1.issuperset(conjunto2))  # issubset significa "es un superconjunto?"
print(conjunto2.isdisjoint(conjunto1))  #Verifica si los dos conjuntos tienen por lo menos un número en común